...
const Subscribe = () => {
  return (
    <>
      <div className=" w-[100%] h-[100vh] bg-[#fff] flex items-center justify-center flex-wrap ">
        <div
          className="relative  w-[37%] h-[50vh] rounded-[20px] m-[2rem] bg-cover bg-center p-6"
        ...
        >
          ...
          <div className="relative top-[-1.2rem] flex items-start justify-center flex-col h-[50vh]">
            ...
            <p className="text-[#fff] text-[42px] font-medium mt-2">
        ...
        <div
          className="relative w-[37%] h-[50vh] rounded-[20px] m-[2rem] bg-cover bg-center"
            ...
            <div className=" p-[4rem] flex items-center justify-center h-[50vh] flex-col">
              <div>
                <div className="flex items-center justify-center">
                  ...
                  <div className=" text-[32px] text-[#fff] font-semibold m-5">
